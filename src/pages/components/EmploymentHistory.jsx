    ...
    <>
      <Box>
        ...
        <Text className="head_text">
          Show your relevent experience (last 10 years ). Use bullet points to
          note your achievement. if possible - use number/facts(Acheived X,
                        ...
                        <AccordionPanel mt={5}>
                          <Grid templateColumns="repeat(2, 1fr)" gap={8}>
                            <GridItem>
                              <FormControl
                                isInvalid={
                                  errors.employment_history_data?.[indx]
                                    ?.emp_job_title
                                }
                              >
                                ...
                                <Input
                                  type="text"
                                  {...register(
                                    `employment_history_data.${indx}.emp_job_title`,
                                    {
                            ...
                            <GridItem>
                              ...
                              >
                                ...
                                <Input
                                  type="text"
                                  {...register(
                                    `employment_history_data.${indx}.employer_name`,
                                    {
                            ...
                            <GridItem>
                              ...
                              >
                                ...
                                <Input
                                  type="date"
                                  {...register(
                                    `employment_history_data.${indx}.emp_date`,
                                    {
                            ...
                            <GridItem>
                              ...
                              >
                                ...
                                <Input
                                  type="text"
                                  {...register(
                                    `employment_history_data.${indx}.emp_city`,
                                    {
